...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 dark:bg-black text-slate-800 dark:text-white flex flex-col font-sans antialiased transition-colors duration-200">
      {/* Top Header Navbar */}
      <Navbar />
      ...
      <div className="flex flex-1 w-full min-h-[calc(100vh-56px)]">
        ...
        <main className="flex-1 p-3 sm:p-6 pb-24 md:pb-6 overflow-y-auto bg-slate-100/70 dark:bg-black min-h-[calc(100vh-56px)] w-full">
