...
export default function CustomerCrm() {
  ...
  return (
    <div className="w-full max-w-full space-y-4 pb-12">
      ...
      {/* Sleek Compact Header Toolbar (Optimized) */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2.5 bg-white dark:bg-[#09090b] border border-slate-200 dark:border-zinc-800 p-3 sm:p-4 rounded-2xl shadow-xs">
        <div className="flex items-center space-x-2 min-w-0">
          <div className="p-1.5 bg-indigo-50 dark:bg-indigo-950/60 text-indigo-600 dark:text-indigo-400 rounded-xl shrink-0">
          ...
          <div className="min-w-0 flex-1">
            <div className="flex items-center space-x-2">
              ...
              <span className="px-2 py-0.5 rounded-lg text-[10px] sm:text-xs font-mono font-bold bg-indigo-100 dark:bg-indigo-950 text-indigo-700 dark:text-indigo-300 shrink-0">
                {customers.length}
              </span>
            </div>
          </div>
        ...
        <div className="flex items-center space-x-2 shrink-0">
          ...
          <div className="relative flex-1 sm:flex-none">
            ...
            <input
              ...
              className="w-full sm:w-52 bg-slate-100 dark:bg-zinc-900 border border-slate-200 dark:border-zinc-800 rounded-xl pl-9 pr-3 py-1.5 text-xs text-slate-900 dark:text-white focus:outline-hidden focus:border-indigo-500 font-medium"
            />
          </div>

          <button
            onClick={() => setShowAddModal(true)}
            className="px-3 py-1.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl text-xs font-extrabold flex items-center justify-center space-x-1 transition shadow-xs shrink-0"
          >
