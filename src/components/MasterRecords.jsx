  ...
  return (
    <div className="max-w-7xl mx-auto space-y-4 sm:space-y-6 pb-12">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 bg-white dark:bg-[#09090b] border border-slate-200/80 dark:border-zinc-800 p-4 sm:p-6 rounded-3xl shadow-xs transition-colors duration-200">
        <div>
          <span className="px-3 py-1 bg-indigo-50 dark:bg-indigo-950/60 border border-indigo-200 dark:border-indigo-800 rounded-full text-xs font-bold text-indigo-700 dark:text-indigo-300 uppercase tracking-wider mb-1.5 inline-block">
            📊 Main Database (Master Record)
          </span>
          <h1 className="text-xl sm:text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
            Sales Master Records
          </h1>
          <p className="text-xs sm:text-sm text-slate-500 dark:text-slate-400 font-medium mt-0.5">
            Complete records view of all account credentials, customer orders, warranty days & net profits.
          </p>
        </div>
        ...
        <div className="flex items-center space-x-2">
          <button
            ...
            className="px-3 py-2 bg-slate-100 dark:bg-zinc-800 text-slate-700 dark:text-slate-200 rounded-2xl text-xs font-bold flex items-center space-x-1.5 border border-slate-200 dark:border-zinc-700"
          >
          ...
          <button
            ...
            className="px-4 py-2.5 bg-gradient-to-r from-orange-600 to-amber-600 hover:from-orange-500 hover:to-amber-500 text-white rounded-2xl text-xs font-bold flex items-center justify-center space-x-2 shadow-md shadow-orange-600/20"
          >
